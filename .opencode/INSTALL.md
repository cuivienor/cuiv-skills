...
git clone https://github.com/cuivienor/cuiv-skills.git ~/.config/opencode/cuiv-skills
```
...
```bash
cd ~/.config/opencode/cuiv-skills && git pull
```
...
- Report issues: https://github.com/cuivienor/cuiv-skills/issues
- Documentation: https://github.com/cuivienor/cuiv-skills
